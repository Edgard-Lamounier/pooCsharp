...
namespace WfaCalAreaPerimetro
{
    public partial class Form1 : Form
    {
        ...
        private void btArea_Click(object sender, EventArgs e)
        {
            ...
            {
                Formas objformas = new Quadrado("Quadrado", 
                                           Convert.ToDouble(tbLadoQuadrado.Text));
        ...
        private void InserirAreaQuadradoListView(Formas quadrado)
        {
            string[] formasGeos = new string[6];

            formasGeos[0] = quadrado.Nome;
            formasGeos[1] = tbLadoQuadrado.Text;
            formasGeos[5] = Convert.ToString(quadrado.area());
        ...
        private void InserirAreaCirculoListView(Formas circulo)
        {
            ...
            formasGeos[4] = tbRaio.Text;
            formasGeos[5] = Convert.ToString(circulo.area());
            listViewArea.Items.Add(new ListViewItem(formasGeos));
        }

        // Evento CheckedChanged() para cada RadioButtons
        private void rbQuadrado_CheckedChanged(object sender, EventArgs e)
        {
            pbImagens.Image = Properties.Resources.quadrado; // caminho do arquivo.
            ocultaPainel();
            Limpar();
        ...
        {
            MessageBox.Show("Área: " + forma.area(), this.Text, 
