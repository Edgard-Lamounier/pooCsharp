...
using System.Globalization; // CultureInfo C#
...
namespace WfaSistemaGestaoPfPf
{
    public partial class Form1 : Form
    {
        ...
        {
            InitializeComponent();
            lblNomeFantasia.Visible = false; //altera a visibilidade do componente para false
            tbNomeFantasia.Visible = false;//altera a visibilidade do componente para false
            gerarGradeListViewPf(); // Insere as Grades no listviewPf
            gerarGradelistViewPj();// Insere as Grades no listviewPj
        }

        private void rbPf_CheckedChanged(object sender, EventArgs e)
        {
            mtbCpfCnpj.Mask = "000,000,000-00"; // Cria a maskara para CPF
        ...
        {
            MessageBox.Show("Dados Cadastrados com Sucesso!", this.Text, 
